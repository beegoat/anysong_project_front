...
<footer className="footer footer-center p-10 bg-base-200 text-base-content rounded mt-20">
  <div className="w-full flex justify-center">
    <div className="flex">
      <a href="https://github.com/beegoat" className="link link-hover">
      ...
      <a href="https://velog.io/@beegoat" className="link link-hover">
        <div className="flex mx-10">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75" />
            </svg>
  ...
  <div>
    <p>Copyright © 2023 - All right reserved by Deepal</p>
  </div>
</footer>
    )
}
